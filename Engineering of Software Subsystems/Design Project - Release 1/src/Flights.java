...
/**
 * This class creates and stores all flights in the AFRS System
 * Language Java 1.8 level 8
 * Created 10/12/2017
 * @author Stephen Cook (sjc5897@g.rit.edu)
 */
public class Flights {
    private HashMap<String,ArrayList<FlightInfo>> flights;
    ...
    public HashMap<String, ArrayList<FlightInfo>> getFlights(){
        return this.flights;
    }
}
