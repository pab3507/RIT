...
/**
 * Represents an created Itinerary
 * Implements the ItineraryInterface and is a composite in the Composite pattern
...
public class Itinerary implements ItineraryInterface {
    ...
    /**
     * This is the constructor of the Itinerary Interface
     * @param origin      : String : The origin airport for the Itinerary
     * @param destination : String: The Destination of the Itinerary
     */
     ...
     * @param flight : Itinerary Interface : The flight being added
     */
     ...
     * @param flight : ItineraryInterface: The flight being removed
     */
    ...
    /**
     * Gets the departure time of the Itinerary by getting the departure of the first flight
     * @return String : The departure time of the Itinerary
     */
    ...
    /**
     * Gets the arrival time of the Itinerary by getting the arrival time of the last flight
