...
public class InstructionReader{
    ...
    {{
        put( "PUSH", in -> { int i = in.nextInt();
                             return new Machine.pushConstant( i ); } );
        ...
        put( "SUB", in -> new Machine.Subtraction() );
        put( "MUL", in -> new Machine.Multiplication() );
        put( "DIV", in -> new Machine.Division() );
        put( "NEG", in -> new Machine.Negation() );
